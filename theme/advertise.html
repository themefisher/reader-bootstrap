  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-9 mx-auto">
        <h1 class="mb-4">Advertise</h1>
        <ul class="list-inline">
          <li class="list-inline-item"><a class="text-default" href="">Home
              &nbsp; &nbsp; /</a></li>
          <li class="list-inline-item text-primary">Advertise</li>
        </ul>
      </div>
    </div>
  </div>
     ...
     <div class="row align-items-center justify-content-center">
       <div class="col-lg-5 col-md-6 order-2 order-md-1">
         <div class="pr-lg-4 pr-0">
            <h2 class="mb-3">Get Your Targeted Future Customers For Increasing Business</h2>
            <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
         </div>
       </div>
       <div class="col-lg-5 col-md-6 mb-4 mb-md-0 order-1 order-md-2">
         <img class="img-fluid w-100" src="images/xvertise.png">
       </div>
     </div>
   </div>
</section>
   ...
   <div class="container">
      <div class="row justify-content-around align-items-center">
         <div class="col-lg-10 mb-5 text-center">
            <h2>The Pricing Table Of <br> Our Solutions</h2>
         </div>
      </div>
            ...
            <div class="row no-gutters justify-content-center pricing-wrapper shadow rounded bg-white">
               <div class="col-lg-4 pricing-item">
                  <div class="card shadow-none rounded-0">
                     <h3>Listing <br> Collections</h3>
                     <p>Donec facilisis tortor ut augue lacinia, at viverra est semper.</p>
                     <div class="price d-flex align-items-center">
                        <h2 class="h1">50€</h2>
                        <span class="text-primary">Starting <br> From</span>
                     </div>
                     <ul class="circle-list">
                        <li>Feature n°1</li>
                        <li>Another feature</li>
                        <li>Such an amazing one</li>
                        <li>I forgot this one too</li>
                     </ul>
   ...
   <div class="container">
     <div class="row align-items-center justify-content-center">
       <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
         <img class="img-fluid w-100" src="images/xvertise-02.png">
       </div>
       <div class="col-lg-5 col-md-6">
         <div class="content pl-lg-5 pl-0">
           <h2 class="mb-3">We offer advertising solutions for every level of expertise</h2>
           <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
         </div>
       </div>
     </div>
...
<section class="section-sm">
   <div class="container">
     ...
     <ul class="nav nav-pills nav-pills-icon row text-center" id="myTab" role="tablist">
        <li class="nav-item col-md-3 col-sm-6" role="presentation">
           <a class="nav-link shadow active" id="tab-one" data-toggle="tab" href="#tabOne" role="tab" aria-controls="tabOne" aria-selected="true">
              <img src="images/faq/icon-01.svg" alt="">
              <h4 class="text-uppercase mt-3 d-block">Pricing & Plans</h4>
           </a>
        </li>
        <li class="nav-item col-md-3 col-sm-6" role="presentation">
           <a class="nav-link shadow" id="tab-two" data-toggle="tab" href="#tabTwo" role="tab" aria-controls="tabTwo" aria-selected="false">
            <img src="images/faq/icon-02.svg" alt="">
            <h4 class="text-uppercase mt-3 d-block">SALES QUESTIONS</h4>
         </a>
        </li>
        <li class="nav-item col-md-3 col-sm-6" role="presentation">
           <a class="nav-link shadow" id="tab-three" data-toggle="tab" href="#tabThree" role="tab" aria-controls="tabThree" aria-selected="false">
            <img src="images/faq/icon-03.svg" alt="">
            <h4 class="text-uppercase mt-3 d-block">usage guides</h4>
         </a>
        </li>
        <li class="nav-item col-md-3 col-sm-6" role="presentation">
